...
use crate::types::{
    Context, CursorStyle, ExitMode, FilterMode, History, HistoryId, HistoryStats, KeymapMode,
    Meaning, PreviewStrategy, SearchMode, Settings, Theme, UiColumn,
};

use crate::tui::history_list::HistoryHighlighter;
use crate::tui::keybindings::KeymapSet;
use crate::tui::engines;
...
pub fn to_compactness(f: &Frame, settings: &Settings) -> Compactness {
    if match settings.style {
        crate::types::Style::Auto => f.area().height < 14,
        crate::types::Style::Compact => true,
        crate::types::Style::Full => false,
    } {
...
pub async fn history(
    ...
    mut db: impl Db,
    theme: &Theme,
    mut entries_rx: tokio::sync::watch::Receiver<()>,
...
#[cfg(test)]
mod tests {
    use crate::types::{Context, FilterMode, History, KeymapMode, Preview, PreviewStrategy, SearchMode, Settings};
    use time::OffsetDateTime;

    use crate::tui::engines::{self, SearchState};
    use crate::tui::history_list::ListState;
    ...
    fn keymap_config_return_query() {
        use crate::types::KeyBindingConfig;
        use ratatui::crossterm::event::{KeyCode, KeyEvent, KeyModifiers};
